...
public class Member {
	...
	public Member(String m_id, String m_pw, String m_name, BigDecimal m_gender, String m_email, BigDecimal m_birth,
			BigDecimal m_phone, BigDecimal m_school, String m_schoolname, String m_schoolmajor, BigDecimal m_working,
			BigDecimal m_army, BigDecimal m_post, String m_addr, String m_addrdetail, String m_station, String m_intro,
			String m_photo) {
		super();
		this.m_id = m_id;
		this.m_pw = m_pw;
	...
	public BigDecimal getM_post() {
		return m_post;
	}

	public void setM_post(BigDecimal m_post) {
		this.m_post = m_post;
	}
